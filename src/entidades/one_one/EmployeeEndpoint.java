...
@Api(name = "employeeendpoint", namespace = @ApiNamespace(ownerDomain = "one_one.entidades", ownerName = "one_one.entidades", packagePath=""))
public class EmployeeEndpoint {
  ...
  public /*CollectionResponse<Employee>*/ List<Employee> listEmployee(
    ...
    return execute;
    /*return CollectionResponse.<Employee>builder()
      .setItems(execute)
